    ...
    if ($.fn.select2) {
        ...
        $('select.xoo-aff-phone_code[select2="yes"]').each(function(key, el) {
            $(el).select2({
                ...
                dropdownCssClass: "xoo-aff-select2-dropdown"
            });
        });
    }
    ...
    class AutoComplete {
        ...
        events() {
            ...
            if (this.$browserFetch.length) {
                this.$browserFetch.on('click', {
                    handler: this
                }, this.browserGetLocation);
            }
        }
        ...
        init() {
            ...
            if (xoo_aff_localize.geolocate_countries) {
                placesArgs.componentRestrictions = {
                    country: xoo_aff_localize.geolocate_countries
                }
            }
