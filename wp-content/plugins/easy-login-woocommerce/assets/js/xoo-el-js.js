jQuery(document).ready(function($) {
    ...
    class CodeFormHandler {
        ...
        events() {
            ...
            this.$resendLink.on('click', {
                _thisObj: this
            }, this.resendCode);
            this.$codeForm.find('.xoo-el-code-no-change').on('click', {
                _thisObj: this
            }, this.changeParentInput);
            this.$codeForm.on('submit', {
                _thisObj: this
            }, this.onSubmit);
            this.$inputs.on('paste', {
                _thisObj: this
            }, this.onCodeInputPaste);
            this.$inputs.on('input', {
                _thisObj: this
            }, this.onCodeInputChange);
            this.$inputs.on('keydown ', {
                _thisObj: this
            }, this.beforeCodeInputChange);
