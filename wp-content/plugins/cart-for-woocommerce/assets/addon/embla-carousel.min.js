! function(n, t) {
    ...
    function x(n, t, e, u, c, a, f, s, d, l, p, v, x, h, y, S) {
        ...
        function C(n) {
            if (!(N = "mousedown" === n.type) || 0 === n.button) {
                var t, r, o = i(u.get(), a.get()) >= 2,
                    f = N || !o,
                    s = (t = n.target, r = t.nodeName || "", !(w.indexOf(r) > -1)),
                    l = o || N && s;
                z = !0, c.pointerDown(n), E.set(u), u.set(a), d.useBaseMass().useSpeed(80),
                    function() {
                        var n = N ? document : e;
                        M.add(n, "touchmove", V).add(n, "touchend", H).add(n, "mousemove", V).add(n, "mouseup", H)
                    }(), k = c.readPoint(n), I = c.readPoint(n, b), v.emit("pointerDown"), f && (L = !1), l && n.preventDefault()
            }
        }
        ...
        function H(n) {
            var e = l.byDistance(0, !1).index !== p.get(),
                ...
                f = function(n, t) {
                    ...
                    return y || r(n) < T ? u : !h && i ? .4 * u : S && t ? .5 * u : l.byIndex(e.get(), 0).distance
                }(t.apply(a), e),
                m = function(n, t) {
                    if (0 === n || 0 === t) return 0;
                    if (r(n) <= r(t)) return 0;
        ...
        return {
            addActivationEvents: function() {
                var n = e;
                A.add(n, "touchmove", (function() {})).add(n, "touchend", (function() {})).add(n, "touchstart", C).add(n, "mousedown", C).add(n, "touchcancel", H).add(n, "contextmenu", H).add(n, "click", R)
            },
    ...
    function h(n, t, e) {
        var r, i, u = (r = 2, i = Math.pow(10, r), function(n) {
        ...
        var m = {
            ...
            seek: function(t) {
                f.set(t).subtract(n);
                var e, r, i, u, p = (e = f.get(), (i = 0) + (e - (r = 0)) / (100 - r) * (d - i));
    ...
    function E(n, t, e, i, u) {
        ...
        function d(t, r) {
            var i = [t, t + e, t - e];
            return n ? s(r ? i.filter((function(n) {
                return o(n) === r
            })) : i) : i[0]
        }
        return {
            byDistance: function(e, o) {
                ...
                return !o || v ? {
                    ...
                    index: l,
                    distance: e + d(t[l] - p, 0)
                }
            },
            byIndex: function(n, e) {
                return {
                    index: n,
                    distance: d(t[n] - u.get(), e)
                }
            },
            shortcut: d
        }
    ...
    function M(n, t, e, r, o, i, c, a, f) {
        var s, d = u(o),
            l = u(o).reverse(),
            p = (s = i[0] - 1, x(m(l, s), "end")).concat(function() {
                var n = e - i[0] - 1;
        ...
        return {
            groupSlides: function(n) {
                return o ? function(n, t) {
                    return u(n).filter((function(n) {
                        return n % t == 0
                    })).map((function(e) {
                        return n.slice(e, e + t)
                    }))
                }(n, r) : function(n) {
                    return u(n).reduce((function(n, r) {
        ...
        var f = o.align,
            ...
            Y = function(n, t, e, o, i, u, f) {
                var s, d = n.startEdge,
                    ...
                    g = (s = c(m) - c(i), p(m).map((function(n) {
                        return n[0]
                    })).map((function(n, t, e) {
                        var r = !t,
                            o = t === a(e);
                ...
                return {
                    ...
                    pointerUp: function(n) {
                        ...
                        var o = u(e) - u(t),
                            ...
                            a = i(n) - i(e) > 170,
                            f = o / c;
                        return c && !a && r(f) > .1 ? f : 0
                    },
                    readPoint: u
                }
            }(R), cn, on, dn, fn, sn, tn, i, F, k, z, L),
            vn = {
                containerRect: C,
                slideRects: V,
                animation: on,
    ...
    function I(n, t, e) {
        ...
        function b(t, e) {
            if (!g) {
                ...
                if (r.translate.to(r.location), y = e || y, o = s.init(y, O), h.loop) {
                    if (!r.slideLooper.canLoop()) return E(), b({
                        loop: !1
                    }, e);
                    r.slideLooper.loop()
                }
        ...
        return b(t, e), a.add(window, "resize", (function() {
            var n = f.atMedia(x),
                t = !f.areEqual(n, h),
