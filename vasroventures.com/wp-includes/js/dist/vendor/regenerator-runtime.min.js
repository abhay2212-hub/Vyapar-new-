var runtime = function(a) {
    ...
    var u, t = Object.prototype,
        h = t.hasOwnProperty,
        l = Object.defineProperty || function(t, r, e) {
            t[r] = e.value
        },
    ...
    function c(t, r, e, n) {
        var o, i, a, c, r = r && r.prototype instanceof d ? r : d,
            ...
            n = new O(n || []);
        return l(r, "_invoke", {
            value: (o = t, i = e, a = n, c = s, function(t, r) {
                ...
                for (a.method = t, a.arg = r;;) {
                    ...
                    if (e) {
                        e = function t(r, e) {
                            var n = e.method;
                            var o = r.iterator[n];
                            if (o === u) return e.delegate = null, "throw" === n && r.iterator.return && (e.method = "return", e.arg = u, t(r, e), "throw" === e.method) || "return" !== n && (e.method = "throw", e.arg = new TypeError("The iterator does not provide a '" + n + "' method")), v;
                            n = f(o, r.iterator, e.arg);
                            if ("throw" === n.type) return e.method = "throw", e.arg = n.arg, e.delegate = null, v;
                            o = n.arg;
                            if (!o) return e.method = "throw", e.arg = new TypeError("iterator result is not an object"), e.delegate = null, v; {
                                if (!o.done) return o;
                                e[r.resultName] = o.value, e.next = r.nextLoc, "return" !== e.method && (e.method = "next", e.arg = u)
                            }
                            e.delegate = null;
                            return v
                        }(e, a);
                    ...
                    if ("next" === a.method) a.sent = a._sent = a.arg;
                        ...
                        if (c === s) throw c = g, a.arg;
                        a.dispatchException(a.arg)
                    } else "return" === a.method && a.abrupt("return", a.arg);
                    c = y;
                    e = f(o, i, a);
                    if ("normal" === e.type) {
                        if (c = a.done ? g : p, e.arg !== v) return {
                            value: e.arg,
                            done: a.done
                        }
                    } else "throw" === e.type && (c = g, a.method = "throw", a.arg = e.arg)
                }
            })
        }), r
    }
    ...
    var r = {},
        ...
        b = b && b(b(k([]))),
        L = (b && b !== t && h.call(b, n) && (r = b), w.prototype = d.prototype = Object.create(r));
            ...
            value: function(e, n) {
                function t() {
                    return new c(function(t, r) {
                        ! function r(t, e, n, o) {
                            var i, t = f(a[t], a, e);
                            if ("throw" !== t.type) return (e = (i = t.arg).value) && "object" == typeof e && h.call(e, "__await") ? c.resolve(e.__await).then(function(t) {
                                r("next", t, n, o)
                            }, function(t) {
                                r("throw", t, n, o)
    ...
    return l(L, "constructor", {
        ...
        return Object.setPrototypeOf ? Object.setPrototypeOf(t, w) : (t.__proto__ = w, i(t, o, "GeneratorFunction")), t.prototype = Object.create(L), t
    }, a.awrap = function(t) {
        return {
            __await: t
        }
    }, x(E.prototype), i(E.prototype, e, function() {
        return this
    }), a.AsyncIterator = E, a.async = function(t, r, e, n, o) {
        void 0 === o && (o = Promise);
        var i = new E(c(t, r, e, n), o);
        return a.isGeneratorFunction(r) ? i : i.next().then(function(t) {
            return t.done ? t.value : i.next()
        })
    }, x(L), i(L, o, "Generator"), i(L, n, function() {
        return this
